...
SpendFlow is a high-performance full-stack personal finance and expense management platform built with Next.js 16 App Router, serverless PostgreSQL on Neon, JWT authentication, and audited REST API specifications.
...
- **Financial Analytics**: High-level KPI metric summary (Net Liquidity, Monthly Income, Expenditures, Savings Rate %) + custom responsive SVG charts.
